...
export const dateParse = (v?: string | null): Dayjs | undefined => {
  const d = dayjs.utc(v, dateLocalFormat, true)
  return d.isValid() ? d : undefined
}

export const dateFormat = (d?: Dayjs | null): string | undefined => {
  return d ? d.format(dateLocalFormat) : undefined
}

export const dateDeserialize = (v?: string | null): Dayjs | undefined => {
  const d = dayjs.utc(v, 'YYYY-MM-DD', true)
  return d.isValid() ? d : undefined
}

export const dateSerialize = (d?: Dayjs | null): string | undefined => {
  return d ? d.format('YYYY-MM-DD') : undefined
}

export const dateDeserializeAndFormat = (v?: string | null): string | undefined => {
  return dateFormat(dateDeserialize(v))
}

export const dateParseAndSerialize = (v?: string | null): string | undefined => {
...
export const timeParse = (v?: string | null): Dayjs | undefined => {
  const d = dayjs(v, timeLocalFormat, true).utc()
  return d.isValid() ? d : undefined
}

export const timeFormat = (d?: Dayjs | null): string | undefined => {
  return d ? d.local().format(timeLocalFormat) : undefined
}

export const timeDeserialize = (v?: string | null): Dayjs | undefined => {
  const d = dayjs.utc(v, v && v.length === 5 ? 'HH:mm' : 'HH:mm:ss', true)
  return d.isValid() ? d : undefined
}

export const timeSerialize = (d?: Dayjs | null): string | undefined => {
  return d ? d.format('HH:mm') : undefined
}

export const timeDeserializeAndFormat = (v?: string | null): string | undefined => {
  return timeFormat(timeDeserialize(v))
}

export const timeParseAndSerialize = (v?: string | null): string | undefined => {
...
export const dateTimeParse = (v?: string | null): Dayjs | undefined => {
  const d = dayjs(v, dateTimeLocalFormat, true).utc()
  return d.isValid() ? d : undefined
}

export const dateTimeFormat = (d?: Dayjs | null): string | undefined => {
  return d ? d.local().format(dateTimeLocalFormat) : undefined
}

export const dateTimeDeserialize = (v?: string | null): Dayjs | undefined => {
  const d = dayjs.utc(v)
  return d.isValid() ? d : undefined
}

export const dateTimeSerialize = (d?: Dayjs | null): string | undefined => {
  return d ? d.utc().format('YYYY-MM-DDTHH:mm:00[Z]') : undefined
}

export const dateTimeDeserializeAndFormat = (v?: string | null): string | undefined => {
  return dateTimeFormat(dateTimeDeserialize(v))
}

export const dateTimeParseAndSerialize = (v?: string | null): string | undefined => {
...
export const dateTimeSecondsParse = (v?: string | null): Dayjs | undefined => {
  const d = dayjs(v, dateTimeSecondsLocalFormat, true).utc()
  return d.isValid() ? d : undefined
}

export const dateTimeSecondsFormat = (d?: Dayjs | null): string | undefined => {
  return d ? d.local().format(dateTimeSecondsLocalFormat) : undefined
}

export const dateTimeSecondsDeserialize = (v?: string | null): Dayjs | undefined => {
  const d = dayjs.utc(v)
  return d.isValid() ? d : undefined
}

export const dateTimeSecondsSerialize = (d?: Dayjs | null): string | undefined => {
  return d ? d.format('YYYY-MM-DDTHH:mm:ss[Z]') : undefined
}

export const dateTimeSecondsDeserializeAndFormat = (v?: string | null): string | undefined => {
  return dateTimeSecondsFormat(dateTimeSecondsDeserialize(v))
}

export const dateTimeSecondsParseAndSerialize = (v?: string | null): string | undefined => {
