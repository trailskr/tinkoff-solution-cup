...
export class Pager {
  ...
  public get total (): number | undefined { return this._total }
  public get lastPage (): number { return this._lastPage }

  update (conf: PagerConf): void {
  ...
  getPageOfNthItem (itemIndex: number): number {
